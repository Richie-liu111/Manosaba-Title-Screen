...
这是原 [Manosaba-Title-Screen](https://github.com/Shiiyuko/Manosaba-Title-Screen)（Fabric + Compose Desktop）项目的 Forge 1.20.1 移植版。由于原项目依赖 `androidx.compose.runtime.SnapshotStateKt`，在 Minecraft 环境中无法运行，本项目使用原生 Minecraft GUI（`GuiGraphics` + OpenGL）重新实现，UI 渲染骨架参考了 [YuZuUI-Forge](https://github.com/)。
...
- [YuZuUI-Forge](https://github.com/) — UI 渲染骨架参考